// === scripts/global.js (Final & Corrected Version) ===

// ページのHTMLがすべて読み込まれてから、すべての処理を開始する
document.addEventListener('DOMContentLoaded', () => {
    ...
    // HTML読み込み後なので、確実に<body>タグを見つけることができる
    ...
    const translations = {
        ja: {
            ...
            op_det: "行列式", op_inv: "逆行列", op_eigs: "固有値/ベクトル", op_lu: "LU分解", op_qr: "QR分解", op_trace: "トレース", op_rank: "ランク",
        ...
        en: {
            ...
            op_det: "Determinant", op_inv: "Inverse", op_eigs: "Eigenvalues/vectors", op_lu: "LU Decomposition", op_qr: "QR Decomposition", op_trace: "Trace", op_rank: "Rank",
    ...
    function applyLanguage(lang) {
        ...
        if (titleEl) {
            ...
            if (titleKey && langData[titleKey]) document.title = langData[titleKey];
        }
    }
    ...
    document.body.addEventListener('click', (e) => {
        if (e.target.matches('.op-btn, .tool-btn')) {
